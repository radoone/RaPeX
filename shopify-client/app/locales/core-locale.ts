  ...
  return {
    ...
    manualCheck: {
      ...
      bulk: {
        ...
        description: "Protects {{count}} products: new or changed products get a fresh check, while unchanged products stay protected and are compared with new Safety Gate alerts.",
